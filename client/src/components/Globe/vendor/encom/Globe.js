...
import SmokeProvider from './SmokeProvider';
...
var createParticles = function(){
    ...
    var pointFragmentShader = [
        ...
        "   vec3 fogColor = vec3(" + ((this.fogRgb && this.fogRgb.r) || 0) + "," + ((this.fogRgb && this.fogRgb.g) || 0) + "," + ((this.fogRgb && this.fogRgb.b) || 0) + ");",
    ...
    var indexArray = new Uint16Array(triangles * 3);
...
var createIntroLines = function(){
    ...
    for(let i = 0; i<this.introLinesCount; i++){
        ...
        geometry.sync();
        this.introLines.add(new Line(geometry.buffer, introLinesMaterial));
...
function Globe(width, height, opts){
    ...
    this.satellites = {};
    // this.quadtree = new window.Quadtree2(new Vec2(180, 360), 5);
    this.active = true;
...
Globe.prototype.init = function(cb){
    ...
    this.scene.fog = new Fog( this.fogHex || 0x000000, this.cameraDistance, this.cameraDistance+300 );
